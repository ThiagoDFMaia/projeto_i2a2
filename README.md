...
Este projeto foi desenvolvido como parte do **Desafio** do curso da plataforma [i2a2](https://i2a2.com.br), com foco na criação de agentes de inteligência artificial.
